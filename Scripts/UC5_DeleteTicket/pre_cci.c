...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"a3b541b8b6334946ad49189c03d1767d\",\"statu"
...
Action()
{
	...
	lr_param_sprintf("c_buffer","%s%s=on&", lr_eval_string("{c_buffer}"), lr_eval_string("{c_flightids_count}"));  
