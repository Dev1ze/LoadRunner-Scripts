Action()
{
	lr_start_transaction("UC1_LoginLogout"); /*Õ¿◊¿ÀŒ √À¿¬ÕŒ… “–¿Õ«¿ ÷»»*/
	...
	lr_start_transaction("OpenLandingPage"); /*Õ¿◊¿ÀŒ œ≈–≈’Œƒ¿ Õ¿ √À¿¬Õ”ﬁ —“–¿Õ»÷”*/
	...
	web_url("welcome.pl", 
		...
		"Mode=HTML", 
		LAST);
	lr_end_transaction("OpenLandingPage",LR_AUTO); /*«¿¬≈–ÿ≈Õ»≈ œ≈–≈’Œƒ¿ Õ¿ √À¿¬Õ”ﬁ —“–¿Õ»÷”*/
	
	

	lr_start_transaction("Login"); /*Õ¿◊¿ÀŒ ¿¬“Œ–≈«¿÷»»*/
	...
	web_submit_data("login.pl", 
		...
		LAST);
	lr_end_transaction("Login",LR_AUTO); /*«¿¬–≈ÿ≈Õ»≈ ¿¬“Œ–≈«¿÷»»*/
	
	
	
	lr_start_transaction("SIGNOFF"); /*Õ¿◊¿ÀŒ SIGN OFF*/
	...
	lr_end_transaction("SIGNOFF",LR_AUTO); /*«¿¬–≈ÿ≈Õ»≈ SIGN OFF*/
	lr_think_time(7);
	web_websocket_close("ID=0", "Code=1000", LAST);
	
	
	
 	lr_end_transaction("UC1_LoginLogout", LR_AUTO); /* ŒÕ≈÷ √À¿¬ÕŒ… “–¿Õ«¿ ÷»»*/
