...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"d8114a66e9ab46e0b857bbeecc58ef9f\",\"statu"
...
Action()
{
	...
	while(iteration < countLines)
	{
		...
		lr_output_message("Регистрация №%d", iteration);
		lr_output_message("Пользователь №%s", userNameBuffer);
